...
impl<'raw> ::bebop::SubRecord<'raw> for BebopData<'raw> {
    ...
    fn _serialize_chained<W: ::std::io::Write>(&self, dest: &mut W) -> ::bebop::SeResult<usize> {
        Ok(self.protocol_version._serialize_chained(dest)?
            + self.opcode._serialize_chained(dest)?
            + self.encoded_data._serialize_chained(dest)?)
    }
...
impl<'raw> ::bebop::SubRecord<'raw> for Grid<'raw> {
    ...
    #[allow(unaligned_references)]
    fn _serialize_chained<W: ::std::io::Write>(&self, dest: &mut W) -> ::bebop::SeResult<usize> {
        Ok(self.rows._serialize_chained(dest)?)
    }
...
impl<'raw> ::bebop::SubRecord<'raw> for Row<'raw> {
    ...
    #[allow(unaligned_references)]
    fn _serialize_chained<W: ::std::io::Write>(&self, dest: &mut W) -> ::bebop::SeResult<usize> {
        Ok(self.pixels._serialize_chained(dest)?)
    }
...
impl<'raw> ::bebop::SubRecord<'raw> for Pixel {
    ...
    fn _serialize_chained<W: ::std::io::Write>(&self, dest: &mut W) -> ::bebop::SeResult<usize> {
        Ok(self.x._serialize_chained(dest)?
            ...
            + self.color._serialize_chained(dest)?)
    }
...
impl<'raw> ::bebop::SubRecord<'raw> for Color {
    ...
    #[allow(unaligned_references)]
    fn _serialize_chained<W: ::std::io::Write>(&self, dest: &mut W) -> ::bebop::SeResult<usize> {
        Ok(self.red._serialize_chained(dest)?
            + self.green._serialize_chained(dest)?
            + self.blue._serialize_chained(dest)?)
    }
